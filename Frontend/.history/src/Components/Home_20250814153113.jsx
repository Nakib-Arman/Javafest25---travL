...
export default function Home() {
  ...
  useEffect(() => {
    if (cardRef.current) {
      setCardWidth(cardRef.current.offsetWidth + 15); // 15px gap in CSS
    }
  }, []);
  ...
  return (
    <div className="home-container">
      ...
      <h1 className="review-title">See what our users say</h2>
        <div
          className="review-track"
          style={{
            transform: `translateX(-${reviewIndex * cardWidth}px)`
          }}
        >
